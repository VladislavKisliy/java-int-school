    ...
    public static void main(String[] args) throws IOException {
        ...
        server.addListener(new Listener() {
            ...
            public void received(Connection connection, Object object) {
                if (object instanceof RequestWithList) {
                    RequestWithList request = (RequestWithList) object;
                ...
                } else if (object instanceof RequestWithEnum) {
                    RequestWithEnum request = (RequestWithEnum) object;
                    System.out.println("request from client: " + request);

                    SimpleResponse response = new SimpleResponse();
                    response.setText("Thanks again");
                    response.setHeader("Header long");
                    connection.sendTCP(response);
                }
            }
        });
